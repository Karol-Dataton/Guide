...
export function initToolbar() {
    const toolButtons = {
        ...
        monitor: document.getElementById('add-monitor'),
        sdi: document.getElementById('add-sdi'),
        ...
        tracking: document.getElementById('add-tracking'),
        timecode: document.getElementById('add-timecode'),
