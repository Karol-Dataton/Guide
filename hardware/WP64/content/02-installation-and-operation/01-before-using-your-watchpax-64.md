...
## Before Using Your WATCHPAX 64

**Please read the manual thoroughly before operation.** Always check that the unit has not been damaged in transit when you take delivery.

:::warning
The WATCHPAX 64 is a plug-and-play unit. Do not open, modify or repair the unit yourself. Opening, modifying (software or hardware) or repairing the unit yourself will invalidate the warranty and presents a risk for the user.
:::
...
* Caution: shock hazard if handled carelessly or improperly.
